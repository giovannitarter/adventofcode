...
class TestAoC(unittest.TestCase):
    ...
    def test_sol01_ex(self):
        self.assertEqual(sol.sol01(self.test_data), 24)
        return

    def test_sol02_ex(self):
        self.assertEqual(sol.sol02(self.test_data), 93)
        return

    def test_sol01_input(self):
        res = sol.sol01(self.input_data)
        self.assertNotEqual(res, 361)
        self.assertEqual(res, 873)
        return

    def test_sol02_input(self):
        self.assertEqual(sol.sol02(self.input_data), 24813)
        return
