...
class TestAoC(unittest.TestCase):
    ...
    def test_test01(self):
        ...
        test01
        """
        self.assertEqual(sol.sol01(self.test_data), 357)

    def test_test02(self):
        """
        test02
        """
        self.assertEqual(sol.sol02(self.test_data), 3121910778619)

    def test_input01(self):
        """
        input01
        """
        self.assertEqual(sol.sol01(self.input_data), 17034)

    def test_input02(self):
        """
        input02
        """
        self.assertEqual(sol.sol02(self.input_data), 168798209663590)
