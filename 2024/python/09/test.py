...
class TestAoC(unittest.TestCase):
    ...
    def test_test01(self):
        ...
        test01
        """
        self.assertEqual(sol.sol01(self.test_data), 1928)

    def test_test02(self):
        """
        test02
        """
        self.assertEqual(sol.sol02(self.test_data), 2858)

    def test_input01(self):
        """
        input01
        """
        self.assertEqual(sol.sol01(self.input_data), 6283404590840)

    def test_input02(self):
        """
        input02
        """
        self.assertEqual(sol.sol02(self.input_data), 6304576012713)
